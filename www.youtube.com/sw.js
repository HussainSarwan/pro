/** 10181967587415991812 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  ...
  INNERTUBE_CLIENT_VERSION: "2.20240206.01.00",
  INNERTUBE_CONTEXT: {
    client: {
      hl: "en",
      gl: "IN",
      clientName: "WEB",
      clientVersion: "2.20240206.01.00",
    },
  },
  INNERTUBE_CONTEXT_CLIENT_NAME: 1,
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20240206.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  var policy = self.trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (unused) {
      return "https://www.youtube.com/s/desktop/1c21ae68/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(policy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/1c21ae68/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
