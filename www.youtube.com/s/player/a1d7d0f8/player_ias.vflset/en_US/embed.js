...
*/
  ...
  var Sob = function (a) {
    ...
    Wob = function (a) {
      var b = {},
        c;
      for (c in a)
        (b = { NZ: void 0, BY: void 0 }),
          (b.NZ = v5[c]),
          (b.BY = a[c]),
          (v5[c] = (function (d) {
            return function () {
              var e = g.Ia.apply(0, arguments);
              d.NZ.apply(null, g.oa(e));
              d.BY.apply(null, g.oa(e));
            };
          })(b));
    },
    Xob = function () {},
    ...
    bpb = function (a, b, c) {
      var d = typeof c;
      "object" === d || "function" === d ? (a[b] = c) : Zob(a, b, c);
    },
    cpb = function () {
      var a = new Xob();
      a.__default = bpb;
    ...
    x5 = function (a, b) {
      ...
      b = gpb(a, c, 1 === a.nodeType ? d || b : null);
    ...
    z5 = function () {
      return C5 ? C5.nextSibling : y5.firstChild;
    },
    ipb = function (a, b) {
      C5 = z5();
      var c;
      ...
      c ||
        ("#text" === a
          ? ((a = E5.createTextNode("")), gpb(a, "#text", null))
          : ((c = E5),
            (d = y5),
            "function" === typeof a
              ? (c = new a())
      ...
      if (a !== C5) {
        if (0 <= F5.indexOf(a))
          for (b = y5, c = a.nextSibling, d = C5; null !== d && d !== a; )
            (e = d.nextSibling), b.insertBefore(d, c), (d = e);
        else y5.insertBefore(a, C5);
        C5 = a;
      }
    },
    jpb = function (a, b) {
    ...
    lpb = function (a, b) {
      b = void 0 === b ? {} : b;
      var c = void 0 === b.matches ? hpb : b.matches;
    ...
    ppb = function (a) {
      ...
      if (a.attributes) {
        var b = a.attributes,
          c;
        for (c in b) J5.attributes[c] = b[c](J5.attributes[c]);
      }
      a.c_ && Wob(a.c_);
    },
    qpb = function (a, b) {
    ...
    wpb = function (a, b) {
      K5(b);
      if (a && void 0 !== a.qk && void 0 !== a.rr && void 0 !== a.KA) {
        if (upb(a)) for (b = a.FP; b < a.qk.length; b++) vpb(a.qk[b], a.rr[b]);
        for (; a.qk.length > a.FP; ) a.qk.pop(), a.KA.pop(), a.rr.pop();
      }
    },
    xpb = function (a) {
      M5(a);
      for (var b = 0; b < a.qk.length; b++) {
        var c = a.qk[b],
          d = a.KA[b];
        if (d !== c.version) return !0;
        if (!upb(c) || c.Rl)
          if (c.Rl || 1 !== c.VX)
            (c.UZ(c) || xpb(c)) && c.VZ(c), (c.Rl = !1), (c.VX = 1);
        if (d !== c.version) return !0;
      }
      return !1;
    },
    vpb = function (a, b) {
      ...
      M5(a);
      if (1 === a.fk.length)
        for (var c = 0; c < a.qk.length; c++) vpb(a.qk[c], a.rr[c]);
      c = a.fk.length - 1;
      a.fk[b] = a.fk[c];
      a.ew[b] = a.ew[c];
      a.fk.length--;
      a.ew.length--;
      b < a.fk.length && ((c = a.ew[b]), (a = a.fk[b]), M5(a), (a.rr[c] = b));
    },
    upb = function (a) {
      var b, c;
      return (
        ...
        0 <
          (null !=
          (c = null == a ? void 0 : null == (b = a.fk) ? void 0 : b.length)
            ? c
            : 0)
      );
    },
    ...
    Bpb = function (a, b) {
      ...
      d.MA =
        ...
        (a.destroy = function () {
          if (null !== d.Es || null !== d.schedule) {
            M5(d);
            if (upb(d))
              for (var e = 0; e < d.qk.length; e++) vpb(d.qk[e], d.rr[e]);
            d.qk.length = d.KA.length = d.rr.length = 0;
            d.fk && (d.fk.length = d.ew.length = 0);
            d.Ey();
            d.Es = null;
            d.schedule = null;
            d.Ey = zpb;
    ...
    Epb = function (a) {
      var b = N5;
      b && (b.JE || (b.JE = []), b.JE.push(a));
    },
    Fpb = function (a) {
      var b;
      null == (b = a.JE) || b.forEach(Dpb);
      a.JE && (a.JE = []);
      if (a.FC) {
        b = g.u(a.FC);
    ...
    Jpb = function (a) {
      ...
      if (!b)
        throw Error(
          "The onCleanup function was called outside of an ownership context, meaning it will never be run. Make sure that onCleanup is being called within a reaction or onInit callback."
        );
      if (b === Ipb)
        throw Error(
          "The onCleanup function was called inside the non disposable ownership context, meaning it will never be run. Make sure that onCleanup is being called within a reaction or onInit callback."
        );
      b.FC || (b.FC = []);
      b.FC.push(a);
    },
    ...
    Lpb = function (a, b) {
      if (!a.B && b) {
        ...
        try {
          ...
          var c, d;
          null == (d = J5.ED) ||
            d.call(J5, null == (c = a.j) ? void 0 : c.jC, e);
        }
        a.el = null;
    ...
    Npb = function (a) {
      if (a) {
        ...
        for (d = 0; d < a.childNodes.length; d++) Npb(a.childNodes[d]);
      }
    },
    Ppb = function (a) {
      1 === Opb.push(a) &&
        requestAnimationFrame(function () {
          setTimeout(function () {
            var b = [].concat(g.oa(Opb));
            Opb = [];
            b = g.u(b);
            for (var c = b.next(); !c.done; c = b.next()) {
              c = c.value;
              try {
                for (var d = 0; d < c.length; d++) Npb(c[d]);
              } catch (e) {
                (d = c = void 0),
                  null == (d = (c = J5).ED) || d.call(c, "unknown", e);
              }
            }
          });
        });
    ...
    T5 = function (a, b) {
      return S5.apply(null, [a, b].concat(g.oa(g.Ia.apply(2, arguments))));
    },
    Spb = function (a, b) {
      var c = S5;
      S5 = a;
      ...
      a.isDisposed ||
        ...
        1 === U5.size &&
          Promise.resolve().then(function () {
            for (var b = g.u(U5), c = b.next(); !c.done; c = b.next())
              (c = c.value), U5.delete(c), c.sF();
          }));
    },
    Xpb = function (a, b) {
      var c = Bpb(function () {
        var d = c;
        d.isDisposed || (Fpb(d), O5(d, b));
      }, a);
      Epb(c);
      c.I9 = function () {
        c.destroy();
    ...
    $pb = function (a, b, c) {
      if (
        Object.hasOwnProperty.call(Ypb, a) &&
        ((a = Ypb[a]),
    ...
    bqb = function (a, b, c) {
      ...
      var d = $pb(a.tagName.toLowerCase(), b, function () {
    ...
    dqb = function (a, b) {
      ...
      null == a.rC &&
        ...
        (a.rC = P5(function () {
          Xpb(Vpb, function () {
            for (var d = a.AG, e = a.SU, f = 0; f < d.length; f++) {
              var h = d[f],
                l = b[h]();
              e[f] !== l && ((e[f] = l), c(a, h, l));
            }
              ...
              if (gqb.includes(e))
                throw Error(
                  "The on:" +
                    ...
                    (e + " is not a valid property.")
                );
              a["on" + e] = d;
            }
          } else hqb(a, b, c);
        else
          "function" !== typeof c || null != a.rC
            ? (J5.f6 && (c = bqb(a, b, c)),
              "style" === b
                ? iqb(a, b, c)
                : b.startsWith("prop:")
                ? (a[b.slice(5)] = c)
                : hqb(a, b, c))
            : (a.AG || (a.AG = []), a.SU || (a.SU = []), a.AG.push(b));
    },
    jqb = function (a, b) {
      var c = {}.g8;
      if (null == b ? 0 : b.el) {
    ...
    nqb = function (a, b, c) {
      ((void 0 === c ? 0 : c) ? lqb : mqb)(a, function () {
        V5(b);
      });
    },
    V5 = function (a) {
      if (void 0 !== a && null !== a)
        if (Array.isArray(a)) {
        ...
        } else if (a instanceof g.ce || a instanceof g.je || a instanceof g.me)
          npb(a.toString());
          ...
          var c = typeof a;
          if ("boolean" === c || "number" === c || "string" === c) npb(a);
            ...
            if ("string" === typeof a.type) {
              a.kq || jpb(a.type, a.props.idomKey);
              d = y5;
              for (var h in a.props)
                a.props[h] !== oqb &&
                  ((e = a.props[h]), (f = G5), f.push(h), f.push(e));
              e = J5.attributes;
              e = void 0 === e ? pqb : e;
              f = y5;
              var l = x5(f),
                m = e;
              e = G5;
              l = l.j || (l.j = Yob(e.length));
              for (var n = !l.length || !1, p = 0; p < e.length; p += 2) {
                h = e[p];
                if (n) l[p] = h;
                else if (l[p] !== h) break;
                var q = e[p + 1];
                if (n || l[p + 1] !== q) (l[p + 1] = q), mpb(f, h, q, m);
              }
              if (p < e.length || p < l.length) {
                ...
                for (p = n; p < e.length; p += 2)
                  (n = e[p]),
                    ...
                    delete W5[n];
                w5(l, e.length);
                for (b in W5) mpb(f, b, void 0, m), delete W5[b];
              }
              b = qqb;
              qqb = f = I5.length;
              for (m = b; m < f; m += 5)
                (0, I5[m])(I5[m + 1], I5[m + 2], I5[m + 3], I5[m + 4]);
              qqb = b;
              w5(I5, b);
              w5(e, 0);
              dqb(d, a.props);
              (a.props.skip || a.props.skipchildren) && y5.hasChildNodes()
                ? (C5 = y5.lastChild)
                : V5(a.children);
              B5(null);
              C5 = y5;
            ...
            if (a.type === Rpb) V5(a.children);
            else if (!J5.eX(a)) {
              try {
                f = a.type;
                var r = f.jC;
                if (f === kqb) (a.props.children = a.children), f(a.props);
                else {
                  ...
                  if (!m) {
                    ...
                    var x = a.props,
                      B;
                    if (
                      void 0 === (null == (B = f.prototype) ? void 0 : B.PA)
                    ) {
                      var E = new Mpb(x);
                      E.C = f;
                    } else E = new f(x);
                    E.j = f;
                    E.fM = { GP: E.state, OO: !1 };
                    m = E;
                    m.props = null;
                    v && ((v.__instance = m), (m.el = v));
                  }
                  var F,
                    G = null != (F = m.fM) ? F : { GP: m.state, OO: !1 },
                    P = G.OO,
                    Q = G.GP;
                  m.fM = void 0;
                  f.I6 && (Q = f.I6(a.props, Q));
                  b = !b && !P && !1;
                  m.props = a.props;
                  m.state = Q;
                  if (b) C5 = y5.lastChild;
                  else {
                    b = m;
                    v5.kV(b);
                    var S = b.PA(b.props);
                    S
                      ? (b.props.idomKey && (S.props.idomKey = b.props.idomKey),
                        (q = S))
                      : (q = void 0);
                    if ((b = q))
                      if (((b.kq = a.kq), (l = V5(b)), (a.kq = b.kq), !f.jC))
                        if (l)
                          (f.jC = l.tagName.toLowerCase()),
                            (l.__instance = m),
                            (m.el = l);
                        else if (null == (p = m.rz) ? 0 : p.length)
                          null == (n = J5.ED) ||
                            n.call(
                              J5,
                              "unknown",
                ...
                (b = ha),
                  null == (e = J5.ED) ||
                    e.call(J5, null == (d = a.type) ? void 0 : d.jC, b);
              }
              a.kq && (B5(null), (C5 = y5), (y5 = y5.parentNode), (a.kq = !1));
            }
          }
        }
    },
    sqb = function (a) {
      ...
      var c,
        ...
        e;
      if (z5() && (null == (e = z5()[X5]) ? void 0 : e.key) === d) {
        d = z5();
        c = d[X5];
        if (!c)
          throw Error(
        ...
        if (!b.C0) {
          for (b = 0; b < c.Z8; b++) C5 = z5();
          var f;
          null == (f = c.Inb) || f.call(c, a.props);
          return !0;
        }
        f = b.C0(a.props, c.props);
        a = a.props;
        if ((b = c.props))
          (b.children = a.children), (b.e6 = a.e6), (b.fallback = a.fallback);
        V5(f);
        return !0;
      }
      a = rqb(a.type, a.props);
      a = null != a && a.AN ? a.AN : a;
      a = Array.isArray(a) ? a : [a];
      a = g.u(a);
      for (f = a.next(); !f.done; f = a.next())
        y5.insertBefore(f.value, z5()), (C5 = z5());
      return !0;
    },
    rqb = function (a, b) {
      var c,
        ...
        f = null != c && c.AN ? c.AN : c,
        h = Array.isArray(f) ? f[0] : f,
        l,
        m = null != (l = null == b ? void 0 : b.idomKey) ? l : a;
      l = a.C0;
      h.rC = e;
      e = h[X5] || {};
      Object.assign(e, {
    ...
    wqb = function (a) {
      vqb(function () {
        if (void 0 !== uqb(a))
          throw Error(
            "Reactive components do not support returning a cleanup function from onInit. Use onCleanup instead."
          );
      });
    },
    xqb = function (a) {
    ...
    Cqb = function (a, b) {
      var c = Aqb("onChange"),
        d = Kpb();
      Bqb(c.Vg, b) &&
        ((c.Vg = b), (c.CZ = a), d.sy || (d.sy = []), d.sy.push(c));
    },
    Y5 = function (a, b) {
      Cqb(function () {
        return xqb(a);
    ...
    Z5 = function (a) {
      ...
      Bqb(c.Vg, b) && ((c.Vg = b), (c.value = a()));
      return c.value;
    },
    $5 = function () {
      var a = Z5(function () {
        return zqb(function (b) {
          a.value = b;
          return function () {
            a.value = null;
          };
    ...
    Hqb = function (a) {
      ...
      return [
        c.value,
        function (d) {
          if (null !== R5) throw Error("Can't set state during rendering");
          c.value = "function" === typeof d ? d(c.value) : d;
          b.fM = { GP: b.state, OO: !0 };
          O5(b.qH, function () {
            Tpb(function () {
              if (b.el) {
                var e,
                ...
                try {
                  ...
                  var h, l;
                  null == (l = J5.ED) ||
                    l.call(J5, null == (h = b.j) ? void 0 : h.jC, m);
                }
              }
            });
          });
    ...
    Mqb = function (a) {
      ...
      Lqb ||
        (b(function () {
          for (var c = g.u(Kqb), d = c.next(); !d.done; d = c.next())
            (d = d.value), d();
          Kqb.length = 0;
          Lqb = !1;
        }),
    ...
    Rqb = function (a) {
      function b(x) {
        ...
        if (!B) {
          ...
          null != (F = p.value) &&
            F.ID() &&
            h(g.kH(x, 4) && !g.kH(x, 2) && !g.kH(x, 1024));
        }
      }
      function c() {
        b(a.J.Ub());
      ...
      Y5(
        function () {
          ...
          g.qv(x.getRootNode(), "ytp-pause-overlay-controls-hidden", B);
          return function () {
      ...
      var t = a.J;
      if (f)
        if ((g.qv(t.getRootNode(), "ytp-expand-pause-overlay", !e), e))
          l.value.focus();
        else {
          var v = p.value;
          g.C2(v);
    ...
    Sqb = function (a) {
      ...
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.mv(this.element, "ytp-error-overlay-round-corners");
      this.W = a.D;
      g.M(this, this.title);
      ...
      this.previous.Sa("click", this.W1, this);
      g.M(this, this.ma);
      for (var c = { xz: 0 }; 16 > c.xz; c = { xz: c.xz }, c.xz++) {
        var d = new g.V({
          I: "a",
          S: "ytp-suggestion-link",
          Y: { href: "{{link}}", target: a.W, "aria-label": "{{aria_label}}" },
          V: [
            {
              I: "div",
            ...
            { I: "div", S: "ytp-suggestion-author", ya: "{{views_or_author}}" },
          ],
        });
        g.M(this, d);
        d.Ja(this.suggestions.element);
        var e = d.Ha("ytp-suggestion-link");
        g.us(e, "transitionDelay", c.xz / 20 + "s");
        this.G.T(
          e,
          "click",
          (function (f) {
            return function (h) {
              ...
              b.api.L(
                ...
                ? (b.api.logClick(b.j[l].element),
                  (l = m.Ok()),
                  (m = {}),
                  g.HTa(b.api, m, "emb_rel_err"),
                  (l = g.Fm(l, m)),
                  g.gV(l, b.api, h))
                : g.fV(h, b.api, b.W, n || void 0) &&
                  b.api.Do(m.videoId, n, m.playlistId);
            };
          })(c)
        );
        this.j.push(d);
      ...
      this.next.Sa("click", this.V1, this);
    ...
    Uqb = function (a) {
      ...
      g.qv(a.element, "ytp-scroll-min", 0 <= b);
      g.qv(a.element, "ytp-scroll-max", b <= c);
    },
    Vqb = function (a) {
      for (var b = 0; b < a.suggestionData.length; b++) {
        ...
        if (
          ...
          var l = {};
          g.sU(a.api, "addEmbedsConversionTrackingParams", [l]);
          f = g.Fm(f, g.NP(l, "emb_rel_err"));
        }
        d.element.style.display = "";
        l = d.Ha("ytp-suggestion-title");
        g.Dv.test(c.title)
          ? (l.dir = "rtl")
          : g.qhb.test(c.title) && (l.dir = "ltr");
        l = d.Ha("ytp-suggestion-author");
        g.Dv.test(e) ? (l.dir = "rtl") : g.qhb.test(e) && (l.dir = "ltr");
        d.update({
          views_or_author: e,
          duration: c.isLivePlayback
            ? "Live"
            : c.lengthSeconds
            ? g.uH(c.lengthSeconds)
            : "",
          link: f,
          hover_title: c.title,
          title: c.title,
    ...
    a6 = function (a) {
      ...
      g.M(this, f);
      a.U().C ||
        ((this.j = new Sqb(a)), this.j.Ja(this.element), g.M(this, this.j));
    ...
    Wqb = function (a, b, c) {
      ...
      c = {};
      g.sU(a.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.nd(c) ? b : g.Fm(b, c);
      g.ro(b);
    },
    Xqb = function (a, b) {
    ...
    $qb = function (a, b) {
      var c = a.api.U(),
        d;
      b.reason &&
        (Yqb(b.reason) ? (d = g.GG(b.reason)) : (d = g.tW(g.FG(b.reason))),
        a.Yd(d, "content"));
      var e;
      b.subreason &&
        (Yqb(b.subreason)
          ? (e = g.GG(b.subreason))
          : (e = g.tW(g.FG(b.subreason))),
        a.Yd(e, "subreason"));
      if (b.proceedButton && b.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          ((e = b.text.simpleText),
          (f.textContent = e),
          !Zqb(d, e) && (!c.C || c.embedsErrorLinks))
        ) {
          var h;
          c =
            null == (h = g.U(null == b ? void 0 : b.navigationEndpoint, g.RG))
              ? void 0
              : h.url;
          var l;
          h =
            null == (l = g.U(null == b ? void 0 : b.navigationEndpoint, g.RG))
              ? void 0
              : l.target;
          c &&
        ...
        V: [
          {
            ...
            Y: { "aria-hidden": "true" },
            V: [
              { I: "div", S: "ytp-impression-link-text", ya: "Watch on" },
              { I: "div", S: "ytp-impression-link-logo", V: [Tob()] },
            ],
          },
        ],
      });
    ...
    arb = function (a) {
      var b = {};
      g.sU(a.api, "addEmbedsConversionTrackingParams", [b]);
      return g.Fm(a.api.getVideoUrl(), g.NP(b, "emb_imp_woyt"));
    },
    c6 = function (a) {
      g.V.call(this, {
        I: "div",
    ...
    e6 = function (a) {
      ...
      g.V.call(this, {
        ...
        Y: {
          target: b.W,
          href: "{{url}}",
          "aria-label": g.BK("Watch on $WEBSITE", { WEBSITE: g.BS(b) }),
      ...
      this.T(a, "videodatachange", this.G0);
    ...
    drb = function (a) {
      ...
      this.C = new g.ev(this.P7, 4e3, this);
      this.B = !1;
      ...
      this.hide();
      g.wU(a.app) && (brb(this), this.tL(), crb(this));
      g.M(this, this.C);
    },
    crb = function (a) {
    ...
    brb = function (a) {
      a.watermark ||
        ((a.watermark = new e6(a.api)),
        g.M(a, a.watermark),
        a.watermark.Ja(a.bottomButtons, 0),
        g.qv(a.watermark.element, "ytp-muted-autoplay-watermark", !0),
        (a.j = new g.dH(a.watermark, 0, !0, 100)),
        g.M(a, a.j));
    },
    f6 = function (a) {
      g.V.call(this, {
      ...
      "0" === a.U().controlsType &&
        g.mv(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.mv(this.element, "ytp-pause-overlay-round-corners");
      g.M(this, this.C);
      g.M(this, this.D);
      var c = new g.V({
        I: "button",
        ...
        V: [{ I: "div", S: "ytp-collapse-icon", V: [g.LG()] }],
      });
      g.M(this, c);
      c.Ja(this.element);
      c.Sa("click", this.G, this);
      ...
      this.C.T(this.api, "presentingplayerstatechange", this.Qa);
      this.C.T(this.api, "videodatachange", this.Qa);
      this.hide();
    },
    g6 = function (a) {
      g.V.call(this, {
        ...
        V: [
          {
            ...
            V: [
              ...
              { I: "span", S: "ytp-countdown-timer-time", ya: "{{duration}}" },
            ],
          },
        ],
      });
      ...
      b !== a.W &&
        ...
        b &&
          ...
          a.J.Xc() &&
            ...
            g.M(a, a.D),
            g.KU(a.J, a.D.element, 4),
            (a.B = new g.dH(a.D, 1e3, !1, 100)),
            g.M(a, a.B),
            a.D.hide()),
          (a.G = new g.V({
            I: "div",
          ...
          a.J.L("embeds_web_enable_keto_pause_overlay")
            ? nqb(a.G.element, T5(Rqb, { J: a.J, Se: b }))
            : ((a.C = new f6(a.J, b)), g.M(a, a.C), a.C.Ja(a.G.element)),
          g.KU(a.J, a.G.element, 4),
          irb(a, a.J.Ub())));
    },
    irb = function (a, b) {
      a.B &&
        ((!g.kH(b, 4) && !g.kH(b, 2)) || g.kH(b, 1024)
          ? a.B.hide()
          : a.B.show());
    },
    grb = function (a) {
      var b = a.J;
      a = !!b.Xc();
      g.qv(b.getRootNode(), "ytp-shorts-mode", a);
      if ((b = b.getVideoData())) b.yU = a;
    },
    i6 = function (a, b) {
      var c = a.J.U();
      a = {
        ...
        embedUrl: g.Wea(a.J.U().loaderUrl),
        eventType: b,
        youtubeHost: g.Vl(a.J.U().Ga) || "",
      };
      a.embeddedPlayerMode = c.Ea;
      g.DD("embedsAdEvent", a);
    };
  var u5 = !1;
  var v5 = {
    Fkb: function () {},
  ...
  Xob.prototype = Object.create(null);
  var pqb = cpb();
  var H5 = null;
  var kpb =
  ...
  var krb = Symbol("UNSET"),
    lrb = Symbol("COMPUTING"),
    mrb = Symbol("ERRORED");
  Object.assign({}, j6, {
    value: krb,
    Rl: !0,
    ...
    dW: qpb,
    UZ: function (a) {
      return a.value === krb || a.value === lrb;
    },
    VZ: function (a) {
      if (a.value === lrb) throw Error("Detected cycle in computations.");
      var b = a.value;
      a.value = lrb;
      var c = tpb(a);
      try {
      ...
      b !== krb && b !== mrb && d !== mrb && a.dW(b, d)
        ? (a.value = b)
        : ((a.value = d), a.version++);
    },
  });
  Object.assign({}, j6, { dW: qpb, value: void 0 });
  var ypb = Object.assign({}, j6, {
    GV: !0,
    XM: !1,
    HV: function (a) {
      null !== a.schedule && a.schedule(a.MA);
    },
    sX: !1,
    Ey: zpb,
  });
  var Gpb = Object.create(Object.assign({}, j6, { XM: !0 }));
  var N5 = null;
  var Ipb = {};
  Q5.prototype.kH = function () {};
  Q5.prototype.U5 = function () {};
  Q5.prototype.lH = function () {};
  Q5.prototype.V5 = function () {};
  var R5 = null;
  g.w(Mpb, Q5);
  Mpb.prototype.PA = function (a) {
    var b = this,
      c = R5;
    R5 = this;
    this.D = 0;
  ...
  var Zpb = {
    ...
    Ypb = {
      ...
      link: {
        href: [
          { Cd: 3, Zh: "rel", Ki: "alternate" },
          { Cd: 3, Zh: "rel", Ki: "author" },
          { Cd: 3, Zh: "rel", Ki: "bookmark" },
          { Cd: 3, Zh: "rel", Ki: "canonical" },
          { Cd: 3, Zh: "rel", Ki: "cite" },
          { Cd: 3, Zh: "rel", Ki: "help" },
          { Cd: 3, Zh: "rel", Ki: "icon" },
          { Cd: 3, Zh: "rel", Ki: "license" },
          { Cd: 3, Zh: "rel", Ki: "next" },
          { Cd: 3, Zh: "rel", Ki: "prefetch" },
          { Cd: 3, Zh: "rel", Ki: "dns-prefetch" },
          { Cd: 3, Zh: "rel", Ki: "prerender" },
          { Cd: 3, Zh: "rel", Ki: "preconnect" },
          { Cd: 3, Zh: "rel", Ki: "preload" },
          { Cd: 3, Zh: "rel", Ki: "prev" },
          { Cd: 3, Zh: "rel", Ki: "search" },
          { Cd: 3, Zh: "rel", Ki: "subresource" },
        ],
      },
      script: { defer: [{ Cd: 1 }] },
      source: { src: [{ Cd: 3 }] },
  ...
  g.aw.getInstance();
  var nrb = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:\/?#]*(?:[\/?#]|$))/i,
    k6 = {},
    aqb =
      ((k6[1] = { uq: null, qt: null, Mr: null }),
      (k6[2] = {
        uq: function () {
      ...
      (k6[3] = {
        uq: function (a, b, c) {
          return nrb.test(c) ? c : g.oe.toString();
        },
        qt: function (a) {
      ...
      (k6[7] = { uq: null, qt: null, Mr: null }),
      (k6[8] = { uq: null, qt: null, Mr: null }),
      (k6[10] = {
        uq: null,
        qt: function (a) {
  ...
  var orb = cpb(),
    hqb = orb.__default,
    iqb = orb.style,
    gqb = ["focusin", "focusout"];
  var prb = {};
  ppb({
    attributes:
      ((prb.__default = function () {
        return cqb;
      }),
      (prb.style = function () {
        return cqb;
  ...
  J5.eX = sqb;
  var tqb = Object.create(Object.assign({}, j6, { XM: !0 }));
  ppb({
    c_: {
      kV: function (a) {
        O5(a.qH, function () {
          var b;
          (null == (b = a.sy) ? 0 : b.length) && Fqb(a.sy);
        });
      },
      kH: function (a) {
        O5(a.qH, function () {
      ...
      lH: function (a) {
        var b;
        (null == (b = a.rz) ? 0 : b.length) && a.rz.forEach(Eqb);
      },
    },
  });
  var Kqb = [],
  ...
  g.k.resize = function (a, b) {
    ...
    if (150 >= Math.min(a.width, a.height) || 0 === h || !c.je) this.hide();
    else {
      var l;
      if (e) {
        var m = (l = 28);
      ...
      b &&
        ...
        (m = a / l - this.B),
        (q = Math.floor(m / d)));
      50 > m || g.HU(this.api) ? this.hide() : this.show();
      for (b = 0; b < h; b++) {
        d = this.j[b];
  ...
  g.k.onVideoDataChange = function () {
    ...
    this.W = a.If ? !1 : b.D;
    a.suggestions
      ? (this.suggestionData = g.zt(a.suggestions, function (c) {
    ...
    a.If
      ? this.title.update({
          title: g.BK("More videos from $DNI_RELATED_CHANNEL", {
  ...
  a6.prototype.B = function (a) {
    g.sW.prototype.B.call(this, a);
    var b = this.api.getVideoData();
    if (b.ZB || b.playerErrorMessageRenderer)
      (a = b.ZB)
        ? $qb(this, a)
        : b.playerErrorMessageRenderer &&
          $qb(this, b.playerErrorMessageRenderer);
    else {
      var c;
      a.Zm &&
        (b.Sx
  ...
  b6.prototype.j = function () {
    var a = this.api.getVideoData(),
      b = this.api.U(),
      c = this.api.getVideoData().If,
      d = b.ze,
      e = !b.je,
      f = this.Se.Bg();
    b = b.C;
    d || f || c || e || b || this.api.Xc() || !a.videoId
      ? (this.hide(), this.api.logVisibility(this.element, !1))
      : ((a = arb(this)), this.updateValue("url", a), this.show());
  };
  ...
  c6.prototype.nk = function () {
    var a = this.api.Ub();
    !this.api.Oh() || (g.kH(a, 2) && g.EU(this.api)) || g.kH(a, 64)
  ...
  d6.prototype.C = function () {
    ...
    this.api.U().L("embeds_enable_muted_autoplay") &&
      ...
      (g.kH(a, 2) && !this.Ib
        ? (this.show(),
          this.j ||
            ((this.j = new g.qW(this.api)),
            g.M(this, this.j),
            this.j.Ja(this.D, 0),
            this.j.show()),
          (a = this.api.getVideoData()),
          this.updateValue("text", a.S0),
          g.qv(this.element, "ytp-muted-autoplay-show-end-panel", !0),
          this.api.logVisibility(this.element, this.Ib),
          this.api.xc("onMutedAutoplayEnds"))
        : this.hide());
  };
  d6.prototype.onClick = function () {
    if (!this.B) {
      this.j && (this.j.xa(), (this.j = null));
      g.qv(this.api.getRootNode(), "ytp-muted-autoplay", !1);
      var a = this.api.getVideoData(),
  ...
  g.k.G0 = function () {
    var a = this.api.getVideoData(),
      b =
        this.api.U().ze &&
        !g.kH(this.state, 2) &&
        !g.mU(this.api.getVideoData(1));
    a.mutedAutoplay || g.BG(this, b);
  ...
  g.k.onVideoDataChange = function () {
    var a = this.api.U();
    a.C && g.mv(this.element, "ytp-no-hover");
  ...
  g.k.onClick = function (a) {
    this.api.L("web_player_log_click_before_generating_ve_conversion_params") &&
      this.api.logClick(this.element);
    var b = this.api.getVideoUrl(!g.vH(a), !1, !0, !0);
    if (
      this.api.L("web_player_log_click_before_generating_ve_conversion_params")
    ) {
      var c = {};
      g.sU(this.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.Fm(b, g.NP(c, "emb_yt_watermark"));
    }
    g.gV(b, this.api, a);
    this.api.L("web_player_log_click_before_generating_ve_conversion_params") ||
      this.api.logClick(this.element);
  ...
  f6.prototype.K = function () {
    this.B = !1;
    g.mv(this.api.getRootNode(), "ytp-expand-pause-overlay");
    this.api.Xc() && this.api.logVisibility(this.element, !0);
    this.focus();
  };
  f6.prototype.Qa = function () {
    var a = this.api.Ub();
    g.kH(a, 1) ||
      g.kH(a, 16) ||
      g.kH(a, 32) ||
      (!g.kH(a, 4) || g.kH(a, 2) || g.kH(a, 1024)
  ...
  g.k.create = function () {
    ...
    d && g.rI({ clientPlaybackNonce: d });
    a.qb && jrb(this);
    a.L("embeds_enable_muted_autoplay") &&
      ((this.Z = new drb(this.J)),
      g.M(this, this.Z),
      g.KU(this.J, this.Z.element, 4),
      (this.ra = new d6(this.J)),
      g.M(this, this.ra),
      g.KU(this.J, this.ra.element, 4));
    a.ze &&
      ((this.watermark = new e6(this.J)),
      g.M(this, this.watermark),
      g.KU(this.J, this.watermark.element, 8));
    b &&
      ((this.K = new b6(this.J, b)),
      g.M(this, this.K),
      g.KU(this.J, this.K.element, 8),
      g.wU(this.J.app) && (this.onMutedAutoplayStarts(), this.K.hide()));
    a.B &&
      ((this.ma = new c6(this.J)),
      g.M(this, this.ma),
      g.KU(this.J, this.ma.element, 4));
    ...
    this.j.T(this.J, "videoplayerreset", this.Bw);
    ...
    if ((this.N = g.SC(g.yS(a))))
      (this.countdownTimer = new g6(this.J)),
        g.M(this, this.countdownTimer),
        g.KU(this.J, this.countdownTimer.element, 4),
        this.countdownTimer.hide(),
        this.j.T(this.J, g.vK("embeds"), this.onCueRangeEnter),
        this.j.T(this.J, g.wK("embeds"), this.onCueRangeExit);
    this.Cc(this.J.Ub());
    ...
    (null == (e = this.J.U().getWebPlayerContextConfig())
      ...
      (a = g.VB("IDENTITY_MEMENTO")) &&
      this.J.xm("onMementoChange", a);
  };
  g.k.onCueRangeEnter = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (this.countdownTimer.show(), frb(this.countdownTimer));
  };
  g.k.onCueRangeExit = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (h6(this.countdownTimer), this.countdownTimer.hide());
  };
  g.k.Yb = function () {
  ...
  g.k.Cc = function (a) {
    g.kH(a, 128)
      ? (this.yg ||
          ((this.yg = new a6(this.J)),
          g.M(this, this.yg),
          g.KU(this.J, this.yg.element, 4)),
        this.yg.B(a.lh),
        this.yg.show(),
        g.mv(this.J.getRootNode(), "ytp-embed-error"))
      : this.yg &&
        (this.yg.dispose(),
        (this.yg = null),
        g.ov(this.J.getRootNode(), "ytp-embed-error"));
    if (this.countdownTimer && this.countdownTimer.j)
      if (g.kH(a, 64)) this.countdownTimer.hide(), h6(this.countdownTimer);
      else if (a.isPaused()) {
        var b = this.countdownTimer;
        b.B || ((b.B = !0), (b.G = (0, g.RD)()));
      } else
        a.isPlaying() &&
          this.countdownTimer.B &&
          ((b = this.countdownTimer),
          b.B && ((b.D += (0, g.RD)() - b.G), (b.B = !1), erb(b)));
    irb(this, a);
  };
  g.k.onMutedAutoplayStarts = function () {
    this.J.getVideoData().mutedAutoplay &&
      this.Z &&
      g.qv(this.J.getRootNode(), "ytp-muted-autoplay", !0);
  };
  g.k.onVideoDataChange = function (a, b) {
    var c = this.aE !== b.videoId;
    a = !c && "dataloaded" === a;
    var d = { isShortsModeEnabled: !!this.J.Xc() };
    g.DD("embedsVideoDataDidChange", {
