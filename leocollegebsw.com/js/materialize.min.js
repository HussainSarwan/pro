      ...
      return (
        ...
        this.each(function () {
          ...
          if (c >= 0 && c < m.length) {
            ...
            return void (
              o.length &&
              ("open" === e || ("close" === e && o.hasClass("active"))) &&
              g(o)
            );
          }
          k(),
              ...
              function d() {
                void 0 !== g.data("induration") &&
                  ...
                  void 0 !== g.data("constrainwidth") &&
                    (h.constrainWidth = g.data("constrainwidth")),
              ...
              var e = a(this),
                ...
                g = function () {
                  ...
                  e.hasClass("bottom-sheet")
                    ...
                    : e.velocity(
                        { top: c.startingTop, opacity: 0, scaleX: 0.7 },
                        g
                      );
                },
                h = function (f) {
                  ...
                  if (
                    ...
                    e.hasClass("bottom-sheet")
                      ...
                      : (a.Velocity.hook(e, "scaleX", 0.7),
                        ...
                        e.velocity(
                          { top: c.endingTop, opacity: 1, scaleX: "1" },
                          l
                        ));
                  }
                };
          ...
          i.wrap(j),
            i.on("click", function () {
              ...
              var r = 0,
                ...
                v = 0;
              s > t
                ? ((r = m / l), (u = 0.9 * j), (v = 0.9 * j * r))
                : ((r = l / m), (u = 0.9 * k * r), (v = 0.9 * k)),
      ...
      init: function (b) {
        ...
        return this.each(function (c) {
          var e,
            ...
            t = function (a) {
              return Math.ceil(
                n - a.position().left - a.outerWidth() - k.scrollLeft()
              );
            },
            u = function (a) {
            ...
            v = function (a) {
              q - a >= 0
                ? (h.velocity(
                  ...
                  h.velocity(
                    { left: u(e) },
                    { duration: s, queue: !1, easing: "easeOutQuad", delay: 90 }
                  ))
                : (h.velocity(
                    { left: u(e) },
                    { duration: s, queue: !1, easing: "easeOutQuad" }
              ...
              "mouseenter.tooltip": function (a) {
                var c = function () {
                  m(),
                    ...
                    k.velocity("stop"),
                    l.velocity("stop"),
                    k.css({ visibility: "visible", left: "0px", top: "0px" });
                  var a,
                    c,
                    e,
                    g = f.outerWidth(),
                  ...
                  "top" === i
                    ...
                    : ((a = f.offset().top + f.outerHeight() + d),
                      ...
                      (e = b(c, a, n, j)),
                      (o = "+10px"),
                      l.css({ top: 0, left: 0, marginLeft: n / 2 - r / 2 })),
                  ...
                  if ("touch" == c.gesture.pointerType) {
                    ...
                    if (
                      ...
                      d < b.menuWidth / 2
                        ...
                        e.css(
                          "transform",
                          "translateX(" + (d - b.menuWidth) + "px)"
                        );
                    else {
                      d < window.innerWidth - b.menuWidth / 2
                        ? (i = !0)
                        : d >= window.innerWidth - b.menuWidth / 2 && (i = !1);
    ...
    a(document).ready(function () {
      ...
      Materialize.updateTextFields = function () {
        ...
        a(b).each(function (b, c) {
          ...
          void 0 !== d.attr("placeholder")
            ...
            ? d
                .siblings("label")
                .toggleClass("active", a(c)[0].validity.badInput === !0)
      ...
      var i = function (a) {
          var b = parseInt(a.parent().css("padding-left")),
            c = -7 + b + "px";
          a.velocity(
            { height: "30px", width: "30px", top: "-30px", marginLeft: c },
      ...
      a(document).on("change", g, function (b) {
        ...
        a(document).on("mouseout touchleave", k, function () {
          if (!h) {
            ...
            b.hasClass("active") &&
              b.velocity(
                { height: "0", width: "0", top: "10px", marginLeft: d },
                { duration: 100 }
              ),
              ...
              if (!a.isEmptyObject(e)) {
                ...
                h.length
                  ? ((i = h
                      ...
                      .first()),
                    i.length || h.append(j))
                  : ((i = d.next(".autocomplete-content.dropdown-content")),
                    i.length || d.after(j)),
                  i.length && (j = i);
                var k = function (a, b) {
                    var c = b.find("img"),
                ...
                d.off("blur.autocomplete").on("blur.autocomplete", function () {
                  ...
                  d
                    ...
                    .on("keyup.autocomplete focus.autocomplete", function (g) {
                      f = 0;
                  ...
                  d
                    ...
                    .on("keydown.autocomplete", function (a) {
                      var b,
                        c = a.which,
                        d = j.children("li").length,
                        e = j.children(".active").first();
                      return 13 === c && g >= 0
                        ? ((b = j.children("li").eq(g)),
                          void (
                            b.length &&
                            (b.trigger("mousedown.autocomplete"),
                            a.preventDefault())
                          ))
                        : void (
                            (38 !== c && 40 !== c) ||
                  ...
                  j.on(
                    ...
                    function () {
                      ...
                      d.val(c),
                        d.trigger("change"),
                        m(),
                        "function" == typeof b.onAutocomplete &&
                          b.onAutocomplete.call(this, c);
                    }
                  );
              }
            })
            ...
            var i = a(
              ...
              n = function (b, c, d) {
                var f = c.is(":disabled") ? "disabled " : "",
                  ...
                  h = e
                    ? '<input type="checkbox"' + f + "/><label></label>"
                    : "",
                  j = c.data("icon"),
                  k = c.attr("class");
                if (j) {
        ...
        (d.hasAutocomplete = !a.isEmptyObject(e.autocompleteOptions.data)),
              ...
              d.$document
                ...
                .on("keydown.chips-add", b.CHIPS + " " + b.INPUT, function (c) {
                  ...
                  if (13 === c.which) {
                    if (
                      d.hasAutocomplete &&
                      f.find(".autocomplete-content.dropdown-content").length &&
                      f
                  ...
                  if (
                    ...
                    return (
                      c.preventDefault(), d.selectChip(g - 1, f), void e.blur()
                    );
                }),
              d.$document
          ...
          (this.chips = function (b, c) {
            b.empty(),
              ...
              b.append(
                a('<input id="' + c + '" class="input" placeholder="">')
              ),
              d.setPlaceholder(b);
            var f = b.next("label");
            f.length &&
          ...
          (this.setPlaceholder = function (a) {
            a.data("chips").length && e.placeholder
              ...
              : !a.data("chips").length &&
                ...
                a.find("input").prop("placeholder", e.secondaryPlaceholder);
          }),
          ...
          (this.addChip = function (a, b) {
            if (d.isValid(b, a)) {
              for (
                var c = d.renderChip(a), e = [], f = b.data("chips"), g = 0;
                g < f.length;
                g++
              )
                e.push(f[g]);
        ...
        return this.each(function (c) {
          ...
          function i(c) {
            ...
            if (
              ...
              b.fullWidth
                ? (k = "translateX(0)")
                : ((k = "translateX(" + (O[0].clientWidth - r) / 2 + "px) "),
            ...
            for (
              (!b.noWrap || (u >= 0 && u < x)) &&
                ((j = q[h(u)]),
                a(j).hasClass("active") ||
                  (O.find(".carousel-item").removeClass("active"),
                  a(j).addClass("active")),
                (j.style[F] =
                  k +
                  " translateX(" +
          ...
          function k() {
            ...
            B &&
              ...
              c > 2 || c < -2 ? (i(C - c), requestAnimationFrame(k)) : i(C));
          }
          function l(c) {
            ...
            O.hasClass("initialized")
              ...
              : (O.addClass("initialized"),
                ...
                ["webkit", "Moz", "O", "ms"].every(function (a) {
                  var b = a + "Transform";
                  return (
                    "undefined" == typeof document.body.style[b] ||
                    ((F = b), !1)
                  );
                }),
                a(window)
                ...
                a(this).on("carouselNext", function (a, b) {
                  void 0 === b && (b = 1),
                    ...
                    t !== C &&
                      ((B = C - t), (H = Date.now()), requestAnimationFrame(k));
                }),
  ...
  (function (a) {
    var b = {
      init: function (b) {
        return this.each(function () {
          ...
          e.length ||
            (e = d.wrap(a('<div class="tap-target-wrapper"></div>')).parent()),
            h.length ||
              ((h = a('<div class="tap-target-content"></div>')), d.append(h)),
            f.length ||
          ...
          var i = function () {
            ...
            k = function () {
              ...
              if (!b)
                for (
                  var g = c.parents(), i = 0;
                  i < g.length && !(b = "fixed" == a(g[i]).css("position"));
                  i++
                );
              var j = c.outerWidth(),
                k = c.outerHeight(),
    ...
    a.fn.tapTarget = function (c) {
      return b[c] || "object" == typeof c
        ? b.init.apply(this, arguments)
        : void a.error("Method " + c + " does not exist on jQuery.tap-target");
    };
  })(jQuery);
